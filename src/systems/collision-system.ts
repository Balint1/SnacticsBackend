            ...
            switch (otherColliderTag) {
                case TagType.Food:
                    ...
                    for(let i = 0; i < config.FoodDefaults.growingFactor; i++){
                        let newTail = new SnakeFactory().createSnakePiece(player, tailPosition.position.x, tailPosition.position.y, 0, TagType.SnakeBody, null, null, null, SnakeColorType.GreenSnake, this.entityPool)
